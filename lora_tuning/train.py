...
def train(args):
    ...
    # Value: MSE (if scalar) or Cross Entropy (if WDL)
    ...
    for batch in train_loader:
        ...
        # winner_target = batch['winner_target'].to(device) # (B, 3) - use this for Z (game result) training?
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", required=True, help="Path to training data chunks dir")
